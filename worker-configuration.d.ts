/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec2fdb074521878ec32cc250572353e7)
// Runtime types generated with workerd@1.20251210.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MyContainer" | "GitHubAppConfigDO" | "InteractiveSessionDO";
	}
	interface Env {
		RATE_LIMIT_KV: KVNamespace;
		CLOUD_CODE_WORKER_URL: string;
		...
		INTERACTIVE_SESSIONS: DurableObjectNamespace<import("./src/index").InteractiveSessionDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUD_CODE_WORKER_URL">> {}
}
